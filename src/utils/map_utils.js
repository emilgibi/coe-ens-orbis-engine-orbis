...
export async function getAddressZoneRowsBybvd_id(bvd_id) {
    if (!bvd_id) {
        throw new Error("bvd_id is required");
    }
...
export async function findMatchingAddressZone(bvd_id, lat, lng) {
    const rows = await getAddressZoneRowsBybvd_id(bvd_id);
